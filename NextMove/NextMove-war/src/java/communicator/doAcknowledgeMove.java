 ...
 * @author aabuback
 */
public class doAcknowledgeMove extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            doAcknowledgeRequestObject                 =   doAcknowledgeRequestObject.getJSONObject(Constants.JSON_ACKNOWLEDGE_KEY);
           ...
           System.out.println(doAcknowledgeRequestObject.toString());
             ...
             */
            JSONObject mJSONObjec   =  Constants.checkForAllKeys( doAcknowledgeRequestObject,Constants.acknowledgeRequestParams);
            ...
            String priceQuote     =   doAcknowledgeRequestObject.getString(Constants.JSON_PRICE_QUOTE);
            String condition      =   doAcknowledgeRequestObject.getString(Constants.JSON_CONDITION);
           ...
           movesDb.setConditions(condition);
           movesDb.setPriceQuote(priceQuote);
           movesDb.setMoveStatus(status);
           if(status.compareToIgnoreCase(Constants.MOVE_STATUS_REJECTED_BY_VENDOR)==0){
           ...
           outputObject     =   new JSONObject();
                try {
                    ...
                    outputObject.put(Constants.JSON_MSG,Constants.JSON_ACKNOWLEDGE);
