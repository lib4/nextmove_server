...
public class getMoves extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            JSONObject  getMovesRequestObject     =   new JSONObject( IOUtils.toString(request.getInputStream()));
            getMovesRequestObject                 =   getMovesRequestObject.getJSONObject(Constants.JSON_GETMOVES_KEY);
               
            
           System.out.println(getMovesRequestObject.toString());
            
            /**
             * Check For all the keys are present or not.
             */
            JSONObject mJSONObjec   =  Constants.checkForAllKeys( getMovesRequestObject,Constants.getMovesRequestParams);
            ...
            List<MovesDb> movesDbs  =   movesDbFacade.getMovesByFilter(moveStatus, sourceAddressFilter, destinationAddressFilter);
